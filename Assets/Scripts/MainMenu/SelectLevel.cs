...
public class SelectLevel : MonoBehaviour {
    ...
    {
        if (difficultDropdown.value == 0) levelManager.SelectedDifficult = LevelManager.Difficult.A;
    ...
    public void DropdownChangeDifficult() {
        ...
        if (difficultDropdown.value == 0) levelManager.SelectedDifficult = LevelManager.Difficult.A;
        else if (difficultDropdown.value == 1) levelManager.SelectedDifficult = LevelManager.Difficult.B;
        else if (difficultDropdown.value == 2) levelManager.SelectedDifficult = LevelManager.Difficult.C;
        else if (difficultDropdown.value == 3) levelManager.SelectedDifficult = LevelManager.Difficult.D;
        else if (difficultDropdown.value == 4) levelManager.SelectedDifficult = LevelManager.Difficult.E;
        else if (difficultDropdown.value == 5) levelManager.SelectedDifficult = LevelManager.Difficult.F;
        else if (difficultDropdown.value == 6) levelManager.SelectedDifficult = LevelManager.Difficult.G;
        else if (difficultDropdown.value == 7) levelManager.SelectedDifficult = LevelManager.Difficult.H;
        else if (difficultDropdown.value == 8) levelManager.SelectedDifficult = LevelManager.Difficult.J;
        else levelManager.SelectedDifficult = LevelManager.Difficult.T;
